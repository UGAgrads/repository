 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Jonathan Gluck");
		  toPrint += p1.toString("jgluck8");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Mashal Mannan");
		  toPrint += p2.toString("mmannan3");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Matthew Moreno");
		  toPrint += p3.toString("mmoreno8");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Brandon Foley");
                  toPrint += p4.toString("bfoley9");
                  //Person5 replace P4 with your name
                  //and gburdell5 with your gt id
                  Person5 p5 = new Person5("Kerry Smith");
                  toPrint += p5.toString("ksmith89");
